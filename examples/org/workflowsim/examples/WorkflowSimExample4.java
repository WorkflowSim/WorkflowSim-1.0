 ...
 * one schedulers, one data centers and 20 heterogeneous vms that has different 
 * communication cost (such that HEFT algorithm should work)
 *
 * @author Weiwei Chen
 * @since WorkflowSim Toolkit 1.0
 * @date Nov 9, 2013
 */
public class WorkflowSimExample4 {
